      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            >
               <motion.div whileHover={{ scale: 1.05 }} className="rounded-full border border-violet-500/20 bg-violet-500/5 px-6 py-3 font-sans text-[10px] sm:text-xs uppercase tracking-widest text-violet-200 sm:backdrop-blur-md transition-colors hover:bg-violet-500/10 hover:border-violet-500/30 cursor-default">
                 Analítica
               </motion.div>
               <motion.div whileHover={{ scale: 1.05 }} className="rounded-full border border-white/5 bg-white/5 px-6 py-3 font-sans text-[10px] sm:text-xs uppercase tracking-widest text-neutral-300 sm:backdrop-blur-md transition-colors hover:bg-white/10 hover:border-white/20 cursor-default">
                 Estratégica
               </motion.div>
               <motion.div whileHover={{ scale: 1.05 }} className="rounded-full border border-white/5 bg-white/5 px-6 py-3 font-sans text-[10px] sm:text-xs uppercase tracking-widest text-neutral-300 sm:backdrop-blur-md transition-colors hover:bg-white/10 hover:border-white/20 cursor-default">
                 Orientada a ROI
